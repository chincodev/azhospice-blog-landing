                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-8 col-lg-8 col-8 top-w3layouts p-md-0 text-right">
                                    <ul className="top-right-info">
                                        <li className="mx-3">
                                            <a target="_blank" href="https://www.linkedin.com/company/53872160">
                                                <span className="fa fa-linkedin"></span>
                                            </a>
                                        </li>
                                        <li className="">
                                            <a target="_blank" href="https://www.facebook.com/AZHOSPICEINC/">
                                                <span className="fa fa-facebook"></span>
                                            </a>
                                        </li>
                                        <li className="mx-3">
                                            <a href="https://www.instagram.com/a_zhospiceinc/">
                                                <span className="fa fa-instagram"></span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://twitter.com/hospice_z">

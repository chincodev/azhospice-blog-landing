			            ...
			            <div className="row">
				            <div className="col-lg-4 col-md-6">
					            <div className="card border-0 med-blog">
						            <div className="card-header p-0">
							            <img className="card-img-bottom" src="../images/Health-Care-Team.jpg" alt="image" />
						            </div>
						            <div className="card-body border border-top-0">
							            <div className="mb-3">
								            <h4 className="blog-title card-title m-0">The Hospice Team</h4>
							            </div>
				            ...
				            <div className="col-lg-4 col-md-6 mt-md-0 mt-5">
					            <div className="card border-0 med-blog">
						            ...
						            <div className="card-body border border-top-0">
							            <div className="mb-3">
								            <h4 className="blog-title card-title m-0">Spiritual Counselors
                                            </h4>
                                        </div>
				            ...
				            <div className="col-lg-4 col-md-6 mt-lg-0 mt-5">
					            <div className="card border-0 med-blog">
						            ...
						            <div className="card-body border border-top-0">
							            <div className="mb-3">
								            <h4 className="blog-title card-title m-0">Home Health Aides</h4>
							            </div>
			            ...
			            <div className="row">
				            <div className="col-lg-4 col-md-6">
					            <div className="card border-0 med-blog">
						            ...
						            <div className="card-body border border-top-0">
							            <div className="mb-3">
								            <h4 className="blog-title card-title m-0">Nurses</h4>
							            </div>
				            ...
				            <div className="col-lg-4 col-md-6 mt-md-0 mt-5">
					            <div className="card border-0 med-blog">
						            ...
						            <div className="card-body border border-top-0">
							            <div className="mb-3">
								            <h4 className="blog-title card-title m-0">Physicians</h4>
                                        </div>
				            ...
				            <div className="col-lg-4 col-md-6 mt-lg-0 mt-5">
					            <div className="card border-0 med-blog">
						            ...
						            <div className="card-body border border-top-0">
							            <div className="mb-3">
								            <h4 className="blog-title card-title m-0">Social Workers</h4>
                                        </div>

                    ...
                    <div className="container py-xl-5 py-lg-3">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 agileits_works-grid1 mt-lg-0 mt-sm-5 mt-4 hospice">
                                <img loading="lazy"src="../../images/AZlogoBG_edited1.jpg" alt="A-z hospice logo" className="img-fluid" />
                            </div>												
                            <div className="col-lg-6 agileits_works-grid1 mt-lg-0 mt-sm-5 mt-4 hospice">					
                                <img loading="lazy"src={"../../images/ACHC_20Gold.jpg"} alt="AHC logo" className="img-fluid" />				
                            </div>						
                            <div className="col-lg-6 agileits_works-grid">					

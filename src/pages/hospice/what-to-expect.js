		            ...
		            <div className="container py-xl-5 py-lg-3">
			            ...
			            <div className="row">
			                <div className="col-lg-6 agileits_works-grid">
					            ...
					            <br></br>
                                <h4>With Hospice, You Are in Control</h4>
                                <br></br>
			                ...
			                <div className="col-lg-6 agileits_works-grid1 mt-lg-0 mt-sm-5 mt-4 img-cnt hospice_care">
				                <img loading="lazy"src="../images/3a.jpg" alt="Nurse caring family" className="img-fluid" />
			                </div>												
			                <div className="col-lg-6 agileits_works-grid1 mt-lg-0 mt-sm-5 mt-4 img-cnt hospice_care2">					
				                <img loading="lazy"src="../images/Dw1kv0FQE7.jpg" alt="Nurse caring patient" className="img-fluid" />				
			                </div>								

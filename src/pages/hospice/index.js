	            	...
	            	<div className="container py-xl-5 py-lg-3">
	            		...
	            		<div className="row">
	            			...
	            			<div className="col-lg-6 agileits_works-grid1 mt-lg-0 mt-sm-5 mt-4" style={{textAlign: "center",  margin: "30px 0 30px 0 !important"}}>
	            			    <img loading="lazy"src="../../images/hospice_insurance.jpg" alt="Doctors" className="img-fluid" />
	            			</div>	
	            			<div className="col-lg-6 agileits_works-grid1 mt-lg-0 mt-sm-5 mt-4"  style={{textAlign: "center",  margin: "30px 0 30px 0 !important"}}>					
	            				<img loading="lazy"src="../../images/A-ZxSTAFF.jpg" alt="Nurse with patient" className="img-fluid" />
	            			</div>								
	            			<div className="col-lg-12 agileits_works-grid">															
